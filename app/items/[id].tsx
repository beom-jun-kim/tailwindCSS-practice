    ...
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="flex cursor-pointer items-center space-x-3 py-3 border-t border-b">
          ...
          <div>
            <p className="text-sm font-me text-gray-700">Steve Jebs</p>
        ...
        <div className="mt-5">
          ...
          <p className="text-base my-6 text-gray-700"> {/* text base : text를 리셋 */}
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 font-medium hover:bg-blue-600 bg-blue-500 text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Talk to seller</button>
